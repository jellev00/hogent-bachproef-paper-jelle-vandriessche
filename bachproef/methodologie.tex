...
\begin{itemize}
    ...
    \item drie geïmplementeerde AI-agentvarianten (OpenAI Agent Builder, n8n, Mastra AI) die changelogs en release notes verwerken en samenvatten;
...
\begin{itemize}
    ...
    \item aanbevelingen voor verdere ontwikkeling en mogelijke integratie van het systeem in de bredere ontwikkelprocessen van Springbok.
\end{itemize}

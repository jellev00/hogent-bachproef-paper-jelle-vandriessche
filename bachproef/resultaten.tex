...
In deze benchmark is het judge-model \texttt{gpt-4o-mini} geconfigureerd met een lage temperatuur (\textit{temperature} = 0,1)\footnote{De temperatuurparameter is een instelbare waarde in taalmodellen die de mate van variatie in de gegenereerde output beïnvloedt. Een lagere waarde maakt de output minder willekeurig en dus beter reproduceerbaar.} om consistente en herhaalbare oordelen te garanderen. Elke agent-output wordt beoordeeld op vier kwantitatieve dimensies (schaal 0--10) en twee kwalitatieve indicatoren:
